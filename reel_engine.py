...
NATIVE={
 ...
 # комнаты. Правило на будущее: брать модели с ОДНИМ диктором.
 # Из трёх студийных владелец выбрал на слух hfc_female. По цифрам он тоже
 # хорош: после чистки шум минус 40 дБ, а чистота голоса самая высокая из всех.
